            ...
            if ( buy_vol[0] != 0 ) :
                if ( close > buy_price[0] * (1 + up0) or buy_num[0] >= num_limit0 ) :
                    ...
                    if ( buy_vol[0]*0.999 > BTG_balance ) :
                        upbit.sell_market_order("KRW-BTG", BTG_balance-1)
                    elif ( BTG_balance - buy_vol[0]*0.999 < 0.5) :
                        upbit.sell_market_order("KRW-BTG", buy_vol[0]*0.999-1)
                    else :
            ...
            if ( buy_vol[1] != 0 ) :
                if ( close > buy_price[1] * (1 + up1) or buy_num[1] >= num_limit1 ) :
                    ...
                    if ( buy_vol[1]*0.999 > BTG_balance ) :
                        upbit.sell_market_order("KRW-BTG", BTG_balance - 1)
                    elif ( BTG_balance - buy_vol[1]*0.999 < 0.5) :
                        upbit.sell_market_order("KRW-BTG", buy_vol[1]*0.999-1)
                    else :
            ...
            if ( buy_vol[2] != 0 ) :
                if ( close > buy_price[2] * (1 + up2) or buy_num[2] >= num_limit2 ) :
                    ...
                    if ( buy_vol[2]*0.999 > BTG_balance ) :
                        upbit.sell_market_order("KRW-BTG", BTG_balance-1)
                    elif ( BTG_balance - buy_vol[2]*0.999 < 0.5) :
                        upbit.sell_market_order("KRW-BTG", buy_vol[2]*0.999-1)
                    else :
